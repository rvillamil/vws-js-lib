...
exports.crawlLinkToURLsWithVideoPremieres = function (limit) {
    console.log(`${Constants.DOMAIN}: facade->crawlLinkToURLsWith VideoPremieres data from URL '${Constants.URL_BASE_VIDEOPREMIERES_HD}'`)
...
exports.crawlLinkToURLsWithBillboardFilms = function (limit) {
    console.log(`${Constants.DOMAIN}: facade->crawlLinkToURLsWithBillboardFilms data from URL '${Constants.URL_BASE_BILLBOARDFILMS}'`)
    return linkCrawler.crawlLinksFrom(
        Constants.URL_BASE_BILLBOARDFILMS,
        limit,
        '.pelilist li a'
    )
}
...
exports.crawlLinkToURLsWithLatestTVShows = function (limit) {
    console.log(`${Constants.DOMAIN}: facade->crawlLinkToURLsWithLatestTVShows data from URL '${Constants.URL_BASE_TVSHOWS_HD}'`)
