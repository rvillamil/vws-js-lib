...
// TODO: Necesitmoas las dos funciones aqui : crawlDataShowCollection, crawlDataTVShow
// e.g: https://descargas2020.org/descargar/serie-en-hd/watchmen/temporada-1/capitulo-06/
exports.crawlDataTVShow = function (urlWithTVShow) {
    ...
    return rp(options)
        .then(function ($) {
            ...
            const year = ShowParser.parseYearByRelaseDate(show.releaseDate)
...
exports.crawlDataShowCollection = function (urlWithShowCollection) {
    ...
    return rp(options)
        .then(function ($) {
            ...
            // Procesamos todos los links de la pagina
            linkCrawler.crawlLinksFrom(
            ...
            const title = ShowParser.parseTitle($)
            console.log(`title '${title}'`)
            // TODO: Voy por aqui....para cada link, tenemos que pillar el fichero de torrent...es decir procesar la pagina. Sigo sin ver para que vale el LinkChained ya..
            /*
