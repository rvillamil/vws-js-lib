...
// Constants
//
const DOMAIN = 'descargas2020.org'
const URL_BASE_VIDEOPREMIERES_HD = `https://${DOMAIN}/peliculas-x264-mkv/`
const URL_BASE_BILLBOARDFILMS = `https://${DOMAIN}/estrenos-de-cine/`
const URL_BASE_TVSHOWS_HD = `https://${DOMAIN}/series-hd/`
