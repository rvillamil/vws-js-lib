...
/**
 * Scraping for TVShow data (title, civer, ratting, url with torrent file...etc)
 *
...
function _parseCrawledTVShowPage(show, htmlRawPageWithShow) {
  ...
  show.currentSession = TVShowParser.parseSession($.html())
  show.currentEpisode = TVShowParser.parseEpisode($.html(), show.currentSession)
