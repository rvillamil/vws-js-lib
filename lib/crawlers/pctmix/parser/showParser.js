...
/**
 * Descargamos: https://atomixhq.one/descargar/torrent/serie-en-hd/the-office/temporada-9/capitulo-22-al-23/
 * y localizamos window.location.href = "//pctmix1.com/descargar-torrent/154985_-1627451418-The-Office---Temporada-9--HDTV-720p-AC3-5-1/";
* window.open("//atomtt.com/download/154985_-1627451418-The-Office---Temporada-9--HDTV-720p-AC3-5-1/");
 * https://pctmix1.com/download/154985_-1627451418-The-Office---Temporada-9--HDTV-720p-AC3-5-1.torrent
 */
exports.parseURLToDownload = function ($) {
  const regex = /(atomtt.com\/download\/)(.*)";/gm
  const str = $.root().html()
  let m; let
    urltodownload
  while ((m = regex.exec(str)) !== null) {
    ...
    urltodownload = m[2].replace(/\/$/, '')
  }

  return `https://${siteConstants.DOMAIN}/download/${urltodownload}.torrent`
}
