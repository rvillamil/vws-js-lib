...
/**
 * window.location.href = "//pctmix1.com/descargar-torrent/154985_-1627451418-The-Office---Temporada-9--HDTV-720p-AC3-5-1/";
...
exports.parseURLToDownload = function ($) {
  const regex = /(atomixhq.com\/descargar-torrent\/)(.*)";/gm
  const str = $.root().html()
  let m; let
    urltodownload
  while ((m = regex.exec(str)) !== null) {
