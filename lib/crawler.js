...
exports.crawlTVShows = function (limit, onShowURLCrawled) {
    ...
    return tumejortorrent.crawlURLsWithLatestTVShows(limit)
        .then(showLinksList => {
            //console.log(`crawlTVShows: ${JSON.stringify(crawlTVShows)}\n`)
            return _doCrawl(showLinksList, onShowURLCrawled);
        }).catch(err => {
 ...
 */
function _doCrawl(showLinksList, onShowURLCrawled) {

    var fnDoCrawl = function (showLinks) {
        return _doCrawlAndSearchFrom(showLinks);
    }
    var actions = showLinksList.map(fnDoCrawl);
...
*/
function _doCrawlAndSearchFrom(showLinks) {
    //console.log(`_doCrawlAndSearchFrom -  showLinks: ${showLinks}`)

    return tumejortorrent.crawlDataShow(showLinks.urlDataShow, showLinks.urlCollection)
        .then(show => {
