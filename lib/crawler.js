...
exports.borrame = function (pruenad) {
  console.log ('Borrame:' + pruenad)
  return showLinksCrawlerDescargas2020.crawlLinksFrom(constantsDescargas2020.URL_BASE_VIDEOPREMIERES_HD, 1, '.pelilist li a')
}
...
exports.searchShowInXMDB = function (show, kind, debug = false) {
  console.log(`searchShowInXMDB - Searching in XMDB by spanish title '${show.title}' and year '${show.year}' `)      
