...
exports.crawlURLsWithBillboardFilms = function (limit) {
    return crawlShows('http://tumejortorrent.com/estrenos-de-cine/', limit);
}

exports.crawlURLsWithVideoPremieres = function (limit) {
    return crawlShows('http://tumejortorrent.com/peliculas-x264-mkv/', limit)
}
