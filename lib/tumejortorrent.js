...
exports.crawlURLsWithLatestTVShows = function (limit) {
    ...
    return _crawlURLsShows(URL_BASE_TVSHOWS_HD, limit, 'pelilist')
        .then(urlsWithLatestTVShows => {
            //Se puede sustituir por _crawlURLsShows (url, 1, 'buscarList')??
            //return _crawlListWithFirstEpisodeURL(urlListWithTVShows)
            return _crawlURLsShows(urlsWithLatestTVShows[0], 1, 'buscar-list')
        })
 ...
 */
exports.crawlURLsWithCollection = function (collectionName, limit) {
...
exports.crawlDataShow = function (urlWithShow) {
    ...
    return rp(options)
        .then(function ($) {
            ...
            console.log(`SHOW Collection name::  --> ${show.collectionName}\n\n`)
...
exports.crawlDataShowCollection = function (collectionName, urlsWithCollection) {
    ...
    var fnParseShow = function (urlWithShow) {
        return _crawlURLsShows(urlWithShow, 1, 'buscar-list')
    }
