...
// Constants
//
const URL_BASE_VIDEOPREMIERES_HD = 'https://descargas2020.org/peliculas-x264-mkv/'
...
function _parseURLToDownload(str) {
    ...
    if (urltodownload.substr(-1) === '/') {
        urltodownload = urltodownload.substr(0, urltodownload.length - 1);
    }

    return "https://descargas2020.org/download/" + urltodownload + ".torrent"
}
