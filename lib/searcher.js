    ...
    var actions = searchResults.map(
        ...
        searchResult => {
            ...
            if (searchResult.type == searchResultsConstants.TVSHOWCOLLECTION) {
                ...
                return crawler.crawlTVShowCollectionsByLinkChainedList(linkChainedList
                    , show => {
                        console.log(`TVSHOWCOLLECTION show: ${show}`)
                    })
                    .then(shows => {
                        console.log(`TVSHOWCOLLECTION: ${shows[0]}`)
            ...
            if (searchResult.type == searchResultsConstants.FILM) {
                ...
                return crawler.crawlFilmsByLinkChainedList(linkChainedList, show => {
