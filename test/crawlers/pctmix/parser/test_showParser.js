...
describe('pctmix/parser/showParser', function () {

    describe('#parseFullName()', function () {

        it('should return the text \'\'Watchmen - Temporada 1 [HDTV 720p][Cap.106][AC3 5.1 Castellano][www.pctmix.ORG][www.pctnew.ORG]', function () {
