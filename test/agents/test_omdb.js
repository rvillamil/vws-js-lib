...
describe('agents/omdb', () => {
  describe('#searchShow()', () => {
    ...
    it('Should return one Show object with the Superman', () => omdb.searchShow('Superman')
      .then((show) => {
        // console.log('Show OMDB: ', show)
    ...
    it('Should return one Show object with error not 0', () => omdb.searchShow('dfewpom pmwd')
      .then((show) => {
